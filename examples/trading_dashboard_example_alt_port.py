#!/usr/bin/env python
"""
Trading Dashboard Example with WebSockets (Alternative Port)
...
This version uses port 8766 instead of 8765 to avoid port conflicts.
"""
...
def generate_dashboard_html():
    ...
    html_path = pathlib.Path(__file__).parent / "trading_dashboard_alt_port.html"
